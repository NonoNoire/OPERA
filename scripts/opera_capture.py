...
Usage:
    ...
    python scripts/opera_capture.py input.txt --output-root MicioVault/00_OPERA_Capture
...
The canonical output root is MicioVault/00_OPERA_Capture. Each note is written
as a flat file named after its identifier: OPERA-YYYY-MM-DD-NNN.md.

After writing a note, update 20_OPERA_Dataset/opera_entries_index.csv and
20_OPERA_Dataset/opera_entries.jsonl manually to keep the index consistent.
"""
...
def output_path(output_root: Path, capture: OperaCapture) -> Path:
    return output_root / f"{capture.identifier}.md"
